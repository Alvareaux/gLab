...
class Auxiliary(Figure):
    ...
    def arc_left_line(self):
        line_left_lower_x = (self.__arc.s_radius() + self.__arc.s_delta_radius()) * \
                            np.cos(self.__arc.angle_start) + self.__d_width
        line_left_lower_y = (self.__arc.s_radius() + self.__arc.s_delta_radius()) * \
                            np.sin(self.__arc.angle_start) + self.__d_height
    ...
    def arc_right_line(self):
        line_right_lower_x = (self.__arc.s_radius() + self.__arc.s_delta_radius()) * \
                             np.cos(self.__arc.angle_end) + self.__d_width
        line_right_lower_y = (self.__arc.s_radius() + self.__arc.s_delta_radius()) * \
                             np.sin(self.__arc.angle_end) + self.__d_height
    ...
    def perimeter_arc(self):
        line_left_lower_x = self.__circle.s_radius() * \
                            np.cos(11 / 8 * pi) + self.__d_width
        line_left_lower_y = self.__circle.s_radius() * \
                            np.sin(11 / 8 * pi) + self.__d_height
